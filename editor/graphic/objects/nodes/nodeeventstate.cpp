...
NodeEventState::NodeEventState(const QSharedPointer<NodeEventStateData> &data, bool initialData)
    : GraphicNode(data)
    , eventStateData(data)
{
    if (initialData) {
...
bool NodeEventState::containKeywords(const QString& keywords) const {
